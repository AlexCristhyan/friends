...
namespace Friends
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<FriendDAO>();
            services.AddTransient<CalculoHistoricoDAO>();
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "Friends", Version = "v1" });
